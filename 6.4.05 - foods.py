def get_foods(foods: list[dict], value) -> list[str]:
    filter_foods = filter(lambda x: x['type_food'] == value, foods)
    return list(map(lambda x: x['name'], filter_foods))
